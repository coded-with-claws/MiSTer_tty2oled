...
inline void oled_drawEightPixelXY(int x, int y) { oled_drawEightPixelXY(x-X_OFFSET,y+Y_OFFSET,x,y); };
...
void oled_drawmonochrome(const uint8_t bitmap[]) {
  oled.drawXBitmap(X_OFFSET, Y_OFFSET, bitmap, DispWidth, DispHeight, OLED_WHITE);
}
